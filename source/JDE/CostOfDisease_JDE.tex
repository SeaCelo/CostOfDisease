...
Applied to South Africa as a primary illustration, our preferred medium scenario implies GDP that is on average about 2.1\% below the baseline path over the first two decades and discounted losses of about \$1.43 trillion at a 2\% discount rate, against an NPV cost of aid in perpetuity of roughly \$25 billion. The implied benefit-to-cost ratio of about 57:1 is illustrative of the potential macroeconomic returns across a broad class of high-burden settings.
