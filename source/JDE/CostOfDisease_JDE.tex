...
\begin{table}[H] \centering \captionsetup{width=6.0in}
\caption{\label{tab:NPVdecomposition}Net Present Value of GDP Loss Under Medium Scenario (billions of 2025 USD), South Africa}
\begin{tabular}{crrr}
\hline
