...
\begin{figure}[H]
    ...
    \label{fig:cumDeaths}
    \centering
    \includegraphics[scale=0.75]{./tables_figures_bins/cumulative_excess_deaths.png}
\end{figure}
...
\begin{figure}[H]
    \caption{South African mortality rates by age with and without aid in 2040}
    \label{fig:Mortality}
    \centering
    \includegraphics[scale=0.75]{./tables_figures_bins/mortality_rates.png}
\end{figure}
