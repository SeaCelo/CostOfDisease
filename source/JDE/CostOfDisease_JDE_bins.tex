...
The last column of Table \ref{tab:scenarios} presents the average annual GDP losses over the first 20 years of the simulation horizon. In the medium scenario, our preferred specification, South Africa's GDP declines by about \$17.6 billion per year over 2025--2044 (in 2025 US dollars), or is on average 2.4\% lower over that period than in the baseline path. Under the low excess deaths scenario, the average annual loss is about \$10.7 billion, while in the high excess deaths scenario the average annual GDP loss is about \$25.5 billion. These losses reflect persistent reductions in effective labor supply and human capital accumulation. The GBD-based HIV mortality profile continues to place most excess deaths in working ages, but it also implies a different timing pattern than the earlier broad-bin mapping, with larger average losses in the first two decades and less negative discounted losses over the full 100-year horizon. Total global US development assistance for health was about \$21 billion in 2021, below the average annual GDP loss in the high excess death scenario. If we compare the low-scenario GDP loss to U.S. health assistance to South Africa in 2023, about \$462 million, the implied annual benefit-to-cost ratio is roughly 23 to 1.\footnote{See \href{https://foreignassistance.gov}{https://foreignassistance.gov}.}
...
\begin{table}[htbp]\centering\captionsetup{width=6.0in}
  ...
  \begin{tabular}{>{\smallsize}l |>{\smallsize}l |>{\smallsize}r |>{\smallsize}c ||>{\smallsize}c}
    ...
    \hline\hline
    Low    & \citet{Brink2025}  &  81,958 & 0.194\% & -10.71 \\
    & & & (50\% of baseline) & \\
    \hline
    Medium & \citet{Gandhi2025} & 132,600 & 0.388\% & -17.62 \\
    & & & (baseline) & \\
    \hline
    High   & \citet{KS2025}     & 192,212 & 0.582\% & -25.49 \\
    & & & (150\% of baseline) & \\
    \hline\hline
  \end{tabular}
  \end{threeparttable}
...
Table \ref{tab:NPVLosses} summarizes the net present value (NPV) of cumulative GDP losses under each scenario, with each row representing a different discount rate used for the NPV calculation. In the medium scenario using a 2\% discount rate, the total discounted loss is about \$4.76 trillion (in 2025 US dollars). The low scenario yields a 2\% NPV loss of about \$2.98 trillion, while the high scenario projects losses of about \$6.77 trillion. These values highlight the long-run macroeconomic consequences of disruptions to disease control and treatment services. Relative to the earlier broad-bin mortality mapping, the GBD-based age profile produces larger average GDP losses in the first 20 years but smaller discounted losses over the full horizon because more of the output decline is pushed into later decades. To compare these economic costs to the cost of prevention we can take the amount of foreign assistance for health programs in South Africa before 2025 and assume this support would continue indefinitely. This assistance totaled about \$500 million per year.\footnote{See \href{https://foreignassistance.gov}{https://foreignassistance.gov}.} The NPV (at a 2\% discount rate) of providing this level of funding in perpetuity is \$25 billion. On that comparison, the medium-scenario economic losses are about 190 times larger than the cost of prevention.
...
\begin{table}[H] \centering \captionsetup{width=6.0in}
  ...
  \begin{tabular}{lrrr}
    ...
    \hline\hline
    1\% & -5,674.37 & -9,055.25 & -12,873.88 \\
    2\% & -2,976.15 & -4,755.79 & -6,767.19 \\
    3\% & -1,664.41 & -2,664.33 & -3,795.24 \\
    4\% & -993.46 & -1,593.70 & -2,273.03 \\
    6\% & -423.65 & -683.21 & -977.29 \\
    \hline\hline
  \end{tabular}
\end{table}

These results indicate that the economic burden of disease extends far beyond the direct costs to the health sector. Even in the more optimistic scenario, where the health system absorbs much of the shock, the loss in output is substantial. The high-impact scenario shows that a collapse in treatment access and mitigation capacity could leave GDP on average 3.4\% below the baseline path over the first two decades, with average annual losses of about \$25.5 billion.
...
Applied to South Africa as a primary illustration, our preferred medium scenario implies GDP that is on average about 2.4\% below the baseline path over the first two decades and discounted losses of about \$4.76 trillion at a 2\% discount rate, against an NPV cost of aid in perpetuity of roughly \$25 billion. The implied benefit-to-cost ratio of about 190:1 is illustrative of the potential macroeconomic returns across a broad class of high-burden settings. Using the South Africa GBD HIV mortality profile yields a more data-driven age mapping than either a uniform all-age scaling rule or the earlier broad-bin approach, and it also highlights that the timing of output losses can shift materially with the age pattern of mortality.
